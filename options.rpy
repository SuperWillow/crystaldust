...
define config.name = _("crystaldust_demo")
...
define gui.about = _p("""Это демо-версия моей первой новеллы "Crystaldust", поэтому не судите строго. Если вам понравиться эта игра, то можете ожидать полную версию.
""")
...
define build.name = "crystaldust_demo"
...
define config.save_directory = "crystaldust_demo-1661922820"
